...
import messageObservers from '../Modules/messageObservers';
...
function Home() {
  ...
  const { postMessage } = useMessage('ready to test', messageObservers);
  ...
  useEffect(() => {
    console.log('executei use effect');
              ...
              <Box sx={{ height: '100%' }}>
                <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                  ...
                  >
                    ...
                    <Tab label="DataLayer Push Code (GTM)" value="3" />
                ...
                <FormBox>
                  <FormConfig onSubmit={handleSubmit}>
                    ...
                    <Button
                      sx={{ width: '100%', mb: 2 }}
                      onClick={() => postMessage('catch_css_element')}
                      variant="contained"
                      endIcon={<AiOutlineClear />}
                      type="button"
                      color="error"
